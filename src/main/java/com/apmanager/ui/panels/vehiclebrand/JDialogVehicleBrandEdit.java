 ...
 * @author luis
 */
public class JDialogVehicleBrandEdit extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogVehicleBrandEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogVehicleBrandEdit dialog = new JDialogVehicleBrandEdit(new javax.swing.JFrame(), true);
